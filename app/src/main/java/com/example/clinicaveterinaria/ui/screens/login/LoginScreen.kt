package com.example.clinicaveterinaria.ui.screens.login
...
import com.example.clinicaveterinaria.ui.theme.RojoError
import com.example.clinicaveterinaria.ui.theme.VerdeExito
    ...
    Column(
        ...
        if (mensaje.isNotEmpty()) {
            Text(
                text = mensaje,
                fontSize = 18.sp,
                // (Aquí puedes usar los colores que definiste o Mapearlos en el Theme)
                color = if (mensaje.contains("✅")) VerdeExito else RojoError
            )
        }
    }
